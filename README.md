...
You get 5 workspaces to work with in this layout. Every other workspace is exactly one swipe away. You navigate with direction keys or touchpad gestures — up, down, left, right.
